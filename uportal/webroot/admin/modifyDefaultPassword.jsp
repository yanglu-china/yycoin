...
<form name="modifyPassword" action="../admin/checkuser.do">
	<input type="hidden" name="method" value="modifyPassword">
	<input type="hidden" name="modifyDefaultPassword" value="1">
<p:navigation
    height="22">
    <td width="550" class="navigation"><span style="cursor: pointer;"
        onclick="javascript:history.go(-1)">修改资料</span> &gt;&gt; 修改默认密码</td>
    <td width="85"></td>
</p:navigation>
<br>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="10">
							<tr>
								...
								<td width="6"><img src="../images/dot_r.gif" width="6"
									height="6"></td>
								<td class="caption"><strong>修改默认密码:</strong></td>
							</tr>
						</table>
						</td>
					</tr>
