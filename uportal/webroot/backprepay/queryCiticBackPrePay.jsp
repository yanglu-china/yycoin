...
<head>
<p:link title="申请预收退款管理(中信银行)" link="true" guid="true" cal="true" dialog="true" />
...
function load()
{
     ...
     guidMap = {
         title: '申请预收退款列表(中信银行)',
         url: gurl + 'queryCiticBackPrePay&type=23',
         colModel : [
