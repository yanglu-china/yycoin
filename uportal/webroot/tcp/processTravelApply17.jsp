...
function processBean(opr)
{
    ...
    if ("1" == opr)
    {
        msg = '确定驳回未回款订单激励申请到初始?';
    }
    
    if ("2" == opr)
    {
        msg = '确定驳回未回款订单激励申请到上一步?';
    }
...
<p:navigation height="22">
	<td width="550" class="navigation"><span style="cursor: pointer;"
        onclick="javascript:history.go(-1)">待我处理</span> &gt;&gt; 未回款订单激励申请处理</td>
    <td width="85"></td>
</p:navigation> <br>
...
<p:body width="100%">
	...
	<p:title>
		<td class="caption">
		 <strong>未回款订单激励申请及借款-${my:get('tcpStatus', bean.status)}</strong>
		</td>
	</p:title>
