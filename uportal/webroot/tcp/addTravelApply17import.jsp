...
<html>
<head>
<p:link title="未回款订单激励费用申请" guid="true"/>
...
<p:navigation height="22">
	<td width="550" class="navigation">未回款订单激励费用申请</td>
	<td width="85"></td>
</p:navigation> <br>
                                ...
                                <c:forEach items="${bean.ibList}" var="itemEach" varStatus="vs">
                                    ...
                                    <td align="left">
                                        <select name="ib_type" class="select_class" style="width: 100%;" disabled="disabled">
                                            ...
                                            <c:if test="${itemEach.type == 5}">
                                                <option value="0">中收</option>
                                                <option value="1">激励</option>
                                                <option value="5" selected>未回款订单激励</option>
                                            </c:if>
                                        </select>
                                    </td>
