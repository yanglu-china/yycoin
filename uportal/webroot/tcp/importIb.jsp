...
<html>
<head>
<p:link title="导入中收激励明细" />
<script language="JavaScript" src="../js/common.js"></script>
<script language="JavaScript" src="../js/JCheck.js"></script>
<script language="javascript">
function addBean()
{
	submit('确定导入中收激励明细?', null, checkValue);
}
...
function changeAction()
{
	...
	if (type > 10)
	{
		$O('formEntry').action="../tcp/expense.do?method=importIb";
	}
	else
	{
		$O('formEntry').action="../tcp/apply.do?method=importIb";
	}
}
...
<p:body width="100%">
	...
	<p:subBody width="80%">
		...
		<p:table cells="1">
			<p:cell title="导入模板">
				<a target="_blank"
					href="../admin/down.do?method=downTemplateFileByName&fileName=ibTemplate.xls">下载中收激励导入模板</a>
			</p:cell>
		</p:table>
