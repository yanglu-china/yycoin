...
<p:navigation height="22">
	<td width="550" class="navigation">中收2申请</td>
	<td width="85"></td>
</p:navigation> <br>
                        ...
                        <td>
                            <table width="100%" border="0" cellspacing='1' id="tables_ib">
                                <tr align="center" class="content0">
                                    ...
                                    <td width="10%" align="center">中收2金额</td>
                                    <td width="10%" align="center">其他费用</td>
                                    <td width="5%" align="left"><input type="button" accesskey="B"
                                ...
                                <c:forEach items="${bean.ibList}" var="itemEach" varStatus="vs">
                                    ...
                                    <td align="left">
                                        <input type="number" style="width: 100%" name="ibMoney2" value="${itemEach.ibMoney2}" required readonly="readonly">
                                    </td>

                                    <td align="left">
                                        <input type="number" style="width: 100%" name="motivationMoney2" value="${itemEach.motivationMoney2}" required readonly="readonly">
                                    </td>
