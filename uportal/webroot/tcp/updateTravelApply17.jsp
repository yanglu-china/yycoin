...
<html>
<head>
<p:link title="未回款订单激励申请" guid="true"/>
...
function addBean(opr)
{
    ...
    if ("0" == opr)
    {
        submit('确定修改未回款订单激励申请?', null, checks);
    }
    
    if ("1" == opr)
    {
        submit('确定提交未回款订单激励申请?', null, checks);
    }
    
    if ("2" == opr)
    {
        submit('稽核修改费用,每项费用只能减少.确定提交稽核修改未回款订单激励申请?', null, checks);
    }
}
...
<p:navigation height="22">
	<td width="550" class="navigation">未回款订单激励申请</td>
	<td width="85"></td>
</p:navigation> <br>
