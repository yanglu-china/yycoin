...
<form name="formEntry" action="../sail/outback.do?method=confirmOutBack" method="post">
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellspacing='1' id="tables">
                                <p:cell title="备注">
                                    <textarea rows=5 cols=100 oncheck="notNone;maxLength(1024);" name="note"></textarea>
                                    <font color="red">*</font>
                                </p:cell>
                            </table>
                        </td>
