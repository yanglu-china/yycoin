		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<table width="100%" cellspacing='0' cellpadding="0"  class=""border_table"">
					<tr class="content2">
						<td width="20%" class="border_cell"><table><tr><td align="center">预售时间</td></tr></table></td>
                        <td width="8%" class="border_cell"><table><tr><td align="center">出库时间</td></tr></table></td>
						<td width="8%" class="border_cell"><table><tr><td align="center">产品代码</td></tr></table></td>
						<td width="8%" class="border_cell"><table><tr><td align="center">厂家</td></tr></table></td>
						<td width="20%" class="border_cell"><table><tr><td align="center">产品名称</td></tr></table></td>
						<td width="10%" class="border_cell"><table><tr><td align="center">售价</td></tr></table></td>
                        <td width="8%" class="border_cell"><table><tr><td align="center">数量</td></tr></table></td>
						<td width="8%" class="border_cell"><table><tr><td align="center">机构号</td></tr></table></td>
						<td width="8%" class="border_cell"><table><tr><td align="center">赠品</td></tr></table></td>
						<td width="8%" class="border_cell"><table><tr><td align="center">赠品数量</td></tr></table></td>
						<td width="8%" class="border_cell"><table><tr><td align="center">发票号</td></tr></table></td>
						<td width="8%" class="border_cell"><table><tr><td align="center">发票抬头</td></tr></table></td>
					</tr>
					
					<c:forEach items="${bean.itemList}" var="item" varStatus="vs">
						<tr class="content2">
							<td class="border_cell"><table><tr><td>${item.poDate}</td></tr></table></td>
							<td class="border_cell"><table><tr><td align="center">${year}${month}${day}</td></tr></table></td>
							...
							<td class="border_cell"><table><tr><td>${item.lhwd}</td></tr></table></td>
							<td class="border_cell"><table><tr><td>${item.giftProductName}</td></tr></table></td>
							<td class="border_cell"><table><tr><td>${item.giftProductAmount}</td></tr></table></td>
							<td class="border_cell"><table><tr><td>${item.invoiceNum}</td></tr></table></td>
							<td class="border_cell"><table><tr><td>${item.invoiceHead}</td></tr></table></td>
						</tr>
					</c:forEach>
