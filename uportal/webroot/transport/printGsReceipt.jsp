			...
			<tr>
				...
				<table width="100%" cellspacing='0' cellpadding="0"  class="border">
					<tr class="content2">
						...
						<td width="12%"><table class="border1"><tr><td align="center">订单日期</td></tr></table></td>
						...
						<td width="4%"><table class="border1"><tr><td align="center">推荐标示</td></tr></table></td>
					</tr>
					...
					<tr class="content2">
						...
						<td><table class="border1"><tr><td>${item.recommendation}</td></tr></table></td>
					</tr>
					</c:forEach>
