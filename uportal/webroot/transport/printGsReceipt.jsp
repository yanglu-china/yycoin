			...
			<tr>
				...
				<table width="100%" cellspacing='0' cellpadding="0"  class="border_table">
					<tr class="content2">
						...
						<td width="12%" class="border_cell"><table><tr><td align="center">订单日期</td></tr></table></td>
						...
						<td width="4%" class="border_cell"><table><tr><td align="center">推荐标示</td></tr></table></td>
					</tr>
					...
					<tr class="content2">
						...
						<td class="border_cell"><table><tr><td>${item.recommendation}</td></tr></table></td>
					</tr>
					</c:forEach>
