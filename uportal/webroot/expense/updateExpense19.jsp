...
function addBean(opr)
{
    ...
    if ("0" == opr)
    {
        submit('确定修改特殊流程报销?', null, checks2);
    }
    
    if ("1" == opr)
    {
        submit('确定提交特殊流程报销?', null, checks2);
    }
    
    if ("2" == opr)
    {
        submit('稽核修改费用,每项费用只能减少.确定提交稽核修改特殊流程报销?', null, checks2);
    }
}
...
<p:navigation height="22">
	<td width="550" class="navigation">特殊流程报销</td>
	<td width="85"></td>
</p:navigation> <br>
