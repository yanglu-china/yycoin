...
public class MailAction extends DispatchAction
{
    ...
    private AttachmentDAO mailAttachmentDAO = null;
        ...
        throws ServletException
    {
        ...
        List<AttachmentBean> atts = mailAttachmentDAO.queryEntityBeansByFK(id);
        ...
        throws MYException
    {
        ...
        if ("1".equals(forwardMail))
        {
            ...
            for (String string : ids)
            {
                ...
                {
                    AttachmentBean temp = mailAttachmentDAO.find(string);
        ...
        throws ServletException, IOException
    {
        ...
        AttachmentBean attachment = mailAttachmentDAO.find(id);
    ...
    /**
     * @return the mailAttachmentDAO
     */
    public AttachmentDAO getMailAttachmentDAO()
    {
        return mailAttachmentDAO;
    }

    /**
     * @param mailAttachmentDAO
     *            the mailAttachmentDAO to set
     */
    public void setMailAttachmentDAO(AttachmentDAO mailAttachmentDAO)
    {
