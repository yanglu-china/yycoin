 ...
 * @author ZHUZHU
 * @version 2011-7-20
 * @see TravelApplyActionBackup
 * @since 3.0
 */
public class TravelApplyActionBackup extends DispatchAction
{
     ...
     * default constructor
     */
    public TravelApplyActionBackup()
    {
    }
...
//        }
        ...
        if (bean.isMidOrMotivation() && "1".equals(addOrUpdate)){
            ...
            List<TcpVSOutBean> tcpVSOutBeans = new ArrayList<>();
            ...
            try
            {
                ...
                while (reader.hasNext())
                {
                        ...
                        if ( !StringTools.isNullOrNone(obj[1]))
                        {
                            ...
                            if ( !StringTools.isNullOrNone(obj[2]))
                            {
                                ...
                                if (out == null){
                                    ...
                                    List<TcpVSOutBean> vsOutBeans = this.tcpVSOutDAO.queryEntityBeansByCondition(conditionParse2);
                                    if(!ListTools.isEmptyOrNull(vsOutBeans)){
                                        for (TcpVSOutBean ib:vsOutBeans){
                                            TravelApplyBean apply = this.travelApplyDAO.find(ib.getRefId());
                                            if (apply!= null && apply.getStatus()!=0 && apply.getStatus()!=1){
                                                builder
                                                        .append("<font color=red>第[" + currentNumber + "]行错误:")
                                                        .append(outId+"订单号已提交中收激励报销申请:"+apply.getId())
                                                        .append("</font><br>");
                            ...
                            if ( !StringTools.isNullOrNone(obj[4]))
                            {
                                ...
                                tcpVSOutBean.setAmount(Integer.valueOf(amount));
                            }
                    ...
                    tcpVSOutBeans.add(tcpVSOutBean);
                    }
                }
...
//                ib.setAmount(Integer.valueOf(amountList2.get(i)));
            ...
            throws ServletException
    {
        ...
        vo.setTcpVSOutBeanList(tcpVSOutBeans);
...
//                            }
                    ...
                    //@Deprecated 商品名目前并未用到,导入时只检查该客户可申请金额总数
                    if ( !StringTools.isNullOrNone(obj[3]))
                    {
                        String productName = obj[3];
