...
import com.china.center.oa.sail.action.OutAction;
...
public class ConsignAction extends DispatchAction
{
    ...
    private com.china.center.oa.sail.action.OutAction outAction = null;
...
//        }
	...
	public com.china.center.oa.sail.action.OutAction getOutAction()
    {
        return outAction;
    }
