...
public interface DepotConstant
{
    ...
    String KTKK_SW_DEPOTPART_ID = "A1201310151011526377";
    
    String KTKK_SW_DEPOTPART_NAME = " 空退空开库（仅限商务部操作）_默认仓区";
    ...
    //代发库--直发产品专用(A1201808131402130406)
    String DFK = "A1201808131402130406";

    //代发仓(A1201808131402130407)
    String DFC = "A1201808131402130407";

    String DFC_STR = "代发仓";

    //代发库--南京物流中心(A1201205251506100751)
    String DFK_NJ = "A1201205251506100751";
    //代发库--南京物流中心_默认仓区(A1201205251506100752)
    String DFK_NJ_DEFAULT = "A1201205251506100752";
