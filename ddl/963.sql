...
update `t_center_auth` set name='库存管理' where id='11';

update `t_center_oamenuitem` set auth='11' where id='11';
...
INSERT INTO `t_center_oamenuitem` VALUES ('1926', '中收激励申请统计', '../tcp/apply.do?method=queryIbReport&queryType=1', '19', '1', '1904', '20', '');
